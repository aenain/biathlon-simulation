...
public class WaitQueue<M extends SimProcess, S extends SimProcess> extends desmoj.core.simulator.QueueBased {
	...
	/**
	 * Counter for the sim-processes which have been removed from the
	...
	protected boolean checkProcess(SimProcess p, String where) {
		...
		{
			sendWarning(
					"The sim-process trying to cooperate with another process"
	...
	/**
	 * This method is called from a sim-process which wants to cooperate as a
