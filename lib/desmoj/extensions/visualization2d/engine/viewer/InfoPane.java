...
public class InfoPane extends JTabbedPane implements ActionListener, MouseListener{
	...
	private Vector<InfoContent>	content	= null;
	...
	public InfoPane(ViewerPanel viewer){
		...
		this.infopane	= this;
		this.content	= new Vector<InfoContent>();
	...
	public void addEntity(String entityId, String code){
		...
		for(int i=1; i<this.content.size(); i++){
			InfoContent ic = this.content.elementAt(i);
	...
	class TabContent extends JPanel{
		...
		private Vector<Integer> headerRows		= null;
		private Vector<Integer> oldValueRows	= null;

		public TabContent(String entityId){
			rowData			= new Vector<Vector<String>>();
			headerRows 		= new Vector<Integer>();
			oldValueRows 	= new Vector<Integer>();
			...
			for(int j=0; j<posAttr.length; j++){
				...
				if(v !=null){
					for(int k=v.size()-1; k>-1; k--){
						row = new Vector<String>();
						row.add(posAttr[j]+" ("+k+")");
						Attribute attr = (Attribute) v.get(k);
	...
	class ColoredTableCellRenderer implements TableCellRenderer{
		...
		public ColoredTableCellRenderer(Vector<Integer> headerRows, Vector<Integer> oldValueRows){
