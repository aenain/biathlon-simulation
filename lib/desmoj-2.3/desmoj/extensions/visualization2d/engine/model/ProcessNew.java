...
public class ProcessNew implements Basic {
	...
	private Vector<ProcessEntry> 	entries;
	...
	public ProcessNew(Model model, String praefix, String id, String resourceType, int resourceTotal, String listId){
		...
		this.entries				= new Vector<ProcessEntry>();
		this.listId					= listId;
	...
	public String[][] removeEntry(String entityId, long time) throws ModelException{
		...
		ProcessEntry pe = this.entries.elementAt(index);
	 ...
	 */
	class ProcessEntry{
		Vector<String>	resourceEntityIds;
		Vector<String>	processEntityIds;
		
		public ProcessEntry(){
			this.processEntityIds	= new Vector<String>();
			this.resourceEntityIds 	= new Vector<String>();
		}
