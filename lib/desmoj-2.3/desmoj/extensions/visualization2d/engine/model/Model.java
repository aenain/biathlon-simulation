...
public class Model {
	...
	public void createEntityTyp(String id, String width, String height, 
		...
		new EntityType(id, this, w, h, posStates1, posAttributes, show1); 
	}
	...
	public void createList(String id, String[] name, String defaultEntityType, 
			String numberOfVisible,	String form, String point, String[] deltaSize, boolean isInit, long time) throws ModelException{
	...
	public void createProcessNew(String id, String[] name, String[] abstractProc, 
			...
			String form, String[] showResources, String[] deltaSize,  boolean isInit, long time) throws ModelException{
