...
public class Parameter implements Cloneable{
	...
	public Parameter clone() throws CloneNotSupportedException{
		...
		out.min		= this.min;
		out.max		= this.max;
		Vector<String> values1	= (Vector<String>)this.values.clone();
		//Diese Zeile ist eigentlich nicht noetig, da Strings unilateral sind.
		for(int i=0; i<values1.size(); i++) values1.set(i, new String(this.values.get(i)));
		out.values	= values1;
		//out.values	= new Vector<String>();
